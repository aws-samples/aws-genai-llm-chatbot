  ...
  constructor(scope: Construct, id: string, props: HuggingFaceCustomScriptModelProps) {
    ...
    const buildspec = codebuild.BuildSpec.fromObject({
      ...
      phases: {
        ...
        build: {
          commands: ['echo "Installing Python requirements..."', 'pip3 install -r build/requirements.txt --upgrade', 'echo "Running script.py..."', 'python3 build/script.py'],
        },
      },
    });
    ...
    const containerImage = container || ContainerImages.HF_PYTORCH_INFERENCE_LATEST;
