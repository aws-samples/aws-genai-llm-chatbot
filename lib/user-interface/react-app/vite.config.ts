    ...
    isDev && {
      ...
      writeBundle() {
        ...
        fs.writeFileSync(outputPath, JSON.stringify({
          ...
          config: {
            api_endpoint: `https://${process.env.API_DISTRIBUTION_NAME}/api`,
            websocket_endpoint: `wss://${process.env.API_DISTRIBUTION_NAME}/socket`,
            rag_enabled: ['T', "t", "true", "True", "TRUE", "1"].includes(process.env.RAG_ENABLED),
