...
class BedrockBase(BaseModel, ABC):
    ...
    def _prepare_input_and_invoke_with_streaming(
        self,
        prompt: str,
            ...
            if stream:
                for event in stream: 
                    ...
                    if chunk:
                        ...
                        print(provider)
                        yield {
                            "finish_reason": json_response.get("stop_reason") or json_response.get("completionReason"),
                            "message": json_response.get("completion") or json_response.get("outputText"),
                        }
