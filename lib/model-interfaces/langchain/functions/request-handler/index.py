        ...
        send_to_client(
            {
                ...
                "data": {
                    "sessionId": session_id,
                    # Log a vague message because the error can contain internal information
...
def handler(event, context: LambdaContext):
    ...
    for message in processed_messages:  
        logger.info("Request compelte with status " + message[0] , status=message[0], cause=message[1])
