      ...
      <div className="w-full my-auto flex justify-center items-center pt-6 pb-52 md:pb-40">
        <div className="text-center w-10/12 lg:w-2/3 max-w-4xl">
          <h1 className="mb-2 text-3xl font-semibold ">
            AWS MULTI LLM CHATBOT SAMPLE
          </h1>
          <p className="mb-4 text-xl">
            A comprehensive sample demonstrating how to securely deploy Large
            Language Models
            <br />
          ...
          <div className="flex gap-x-5 gap-y-4 md:gap-y-0 justify-around mb-6 flex-col md:flex-row">
            ...
            <div className="md:w-1/3 bg-white dark:bg-gray-700 py-3 px-2 rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p>
                Deploy open-source LLMs to Amazon SageMaker for inference using
                the new{' '}
                <a
                  className="font-bold text-sky-600 dark:text-sky-400"
                  href="https://huggingface.co/blog/sagemaker-huggingface-llm"
                  rel="noopener noreferrer"
                  target="_blank"
                >
            ...
            <div className="md:w-1/3 bg-white dark:bg-gray-700 py-3 px-2 rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p>
                Deploy models from HuggingFace with custom inference code
                leveraging a complete automation built on{' '}
                <a
                  className="font-bold text-sky-600 dark:text-sky-400"
          ...
          <div className="flex gap-x-5 gap-y-4 md:gap-y-0 justify-around mb-6 flex-col md:flex-row">
            <div className="md:w-2/4 bg-white dark:bg-gray-700 py-3 px-2 rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p>
                SageMaker endpoint is queried for small batches of token
                predictions, enabling incremental response generation.
                <br />
              </p>
              <p className="mt-3">
                Built on top of{' '}
            ...
            <div className="md:w-2/4 bg-white dark:bg-gray-700 py-3 px-2 rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p>
                Standard mode initiates a one-time request to the LLM SageMaker
                endpoint, awaiting the entire response in a single instance.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-around gap-x-5 gap-y-4 md:gap-y-0 flex-col md:flex-row">
            <div className="md:w-2/4 bg-white dark:bg-gray-700 px-2 py-3  rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p className="text-md mb-2">
                and integrated RAG w/ Similarity Search
              </p>
              <p>
                This optional stack is readily available for a seamless
                deployment of a Vector Database on top of{' '}
                <a
                  className="font-bold text-sky-600 dark:text-sky-400"
                  href="https://aws.amazon.com/blogs/compute/introducing-aws-lambda-response-streaming/"
                  rel="noopener noreferrer"
                ...
                with automatic indexing for documents uploaded to a dedicated S3
                Bucket.
              </p>
              <p className="text-sm italic mt-3">
                You can enable/disable this stack in CDK
              </p>
            </div>
            <div className="md:w-2/4 bg-white dark:bg-gray-700 px-2 py-3 rounded-md shadow-md border border-gray-300 dark:border-gray-700">
              ...
              <p>
                This optional stack deploys a React based webapp on Amazon S3
                and Amazon CloudFront to help you interact and experiment with{' '}
                <b>multiple LLMs simultaneously</b> with conversational history
                support.
              </p>
              <p className="text-sm italic mt-3">
                You can enable/disable this stack in CDK
