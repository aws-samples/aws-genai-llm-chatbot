...
|:-------------|:-------------|
| [Secure Messenger GenAI Chatbot](https://github.com/aws-samples/secure-messenger-genai-chatbot) | An HIPAA compliant messenger on Wickr that can interface with this chatbot to provide Q&A service |
